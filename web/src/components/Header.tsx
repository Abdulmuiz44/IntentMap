...
export function Header({ isFetching }: { isFetching?: boolean }) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-black/80 backdrop-blur-md transition-all duration-300">
      {isFetching && (
